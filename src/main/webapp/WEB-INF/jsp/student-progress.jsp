            ...
            <div class="main">
                ...
                <div class="progress">
                    ...
                    <table class="list">
                        ...
                        <tr>
                            <td class="l_col1">${student.surname}</td>
                            <td class="l_col2">${student.name}</td>
                            <td class="l_col3">${student.group.group}</td>
                            <td class="l_col4"><fmt:formatDate value="${student.date}" pattern="dd/MM/yyyy"/></td>
                        </tr>
                    </table>
                </div>
                        ...
                        <table class="list">
                          ...
                          <c:forEach items="${marks}" var="m">
                           <tr>
                                ...
                                <td class="lm_col0">${m.disciplina.disciplina}</td>
