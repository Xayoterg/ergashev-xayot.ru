...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../resources/css/style.css?v=353"></head>
<body>
<div id="container">
    <header>
        <nav class="head">
    ...
    <main>
        <section class="content">
            ...
            <div class="main">
                <h2>Для  семестра заполните следующие данные и нажмите кнопку "Применить".</h2>
                <div class="form_cm">
                    <form action="/term-modifying" method="post">
